...
.
├── ForgeConverterGUI.py     # Main Python script (GUI)
├── node_modules/            # Node.js libraries (required for conversion)
├── README.md                # Documentation
└── package.json             # Node.js project configuration

📜 Credits

    GUI Developer: [LORG1996] & Gemini AI.
    Core Logic: Powered by the forge-convert-utils library by Petr Broz.
